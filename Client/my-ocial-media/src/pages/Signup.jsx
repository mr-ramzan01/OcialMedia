...
export const Signup = () => {
const [data, setData] = useState({full_name: '', email: '', username: '', password: '', authType: 'email-password'});
...
const handleSubmit = (event) => {
  ...
  if(validate) {
    ...
    .then((res) => {
      ...
      else if(res.message==='User has already signed up try to continue with google.') {
        alert(res.message);
      }
      else {
