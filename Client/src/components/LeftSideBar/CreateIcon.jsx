      ...
      >
        ...
        <DialogContent>
          <Stack direction={{xs: 'column', sm: 'row'}} gap="20px">
            <Box overflow="hidden"  borderRadius="10px" width={{xs: '100%', sm: '50%'}}>
              <Carousel
                showStatus={false}
              ...
              >
                {previewImages.map((el) => (
                  <Avatar
                    key={el}
                    sx={{borderRadius: '0', objectFit: 'contain', width: '100%', height: {xs: '250px', sm: '250px', md: '300px'}}}
                    src={el}
                    alt=""
                  />
                ))}
            ...
            <Box width={{xs: '100%', sm: '50%'}}>
              <Stack direction="column">
                <Stack display={{xs: 'none', sm: 'flex'}} direction="row" alignItems="flex-end">
