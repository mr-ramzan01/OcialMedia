...
const { createPosts, postOnCloudinary, getPosts, getExploreData, getSinglePost, getRecentPosts } = require('../controllers/postsController');
...
postsRouter.get('/recent/post', isAuthenticated, getRecentPosts);
